...
export async function POST(request: NextRequest) {
  try {
    ...
    const { chatId, role, content, attachments, toolCalls, componentData } = body;
    ...
    const transformedMessage = {
      ...
      toolCalls: (message as Record<string, unknown>).toolCalls as unknown[] || undefined,
      componentData: (message as Record<string, unknown>).componentData as unknown || undefined,
...
export async function GET(request: NextRequest) {
  try {
    ...
    const transformedMessages = messages.map(msg => ({
      ...
      toolCalls: (msg as Record<string, unknown>).toolCalls as unknown[] || undefined,
      componentData: (msg as Record<string, unknown>).componentData as unknown || undefined,
